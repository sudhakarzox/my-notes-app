        ...
        <div className="bg-white dark:bg-gray-800 shadow-lg rounded-lg">
          <div className="sticky top-0 bg-white dark:bg-gray-800 border-b px-6 py-4 z-10">
            <div className="flex items-start justify-between">
              <div>
                <h1 className="text-2xl font-semibold text-gray-900 dark:text-gray-100">Create new note</h1>
                <p className="text-sm text-gray-500 dark:text-gray-400">Add a title and write your note content below.</p>
              </div>
          ...
          {error && (
            <div className="px-6 pt-4">
              <div className="p-4 bg-red-50 dark:bg-red-900/50 text-sm text-red-600 dark:text-red-400 rounded-lg">
                {error}
              </div>
            </div>
          )}
              ...
              <div className="flex items-center justify-between max-w-5xl mx-auto">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button
                    ...
                    disabled={saving}
                    className="text-sm px-6 py-2 bg-blue-600 text-white rounded-lg disabled:opacity-60 hover:bg-blue-700"
                  >
